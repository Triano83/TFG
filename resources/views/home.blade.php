...
<body>
    ...
    <main>
        @if ($isAdmin)
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-muted">
                                        <button type="button" class="btn btn-dark m-2" data-bs-toggle="modal"
                                            data-bs-target="#addListaModal">Añadir</button> <a
                                            href="{{ route('lista.show') }}"><button type="button"
                                                class="btn btn-dark m-2">Listado</button></a>
            ...
            <!-- Ventana Modal para añadir articulos a la lista de precios -->
            <div class="modal fade" id="addListaModal" tabindex="-1" aria-labelledby="addListaModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addListaModalLabel">Añadir Artículo</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="{{ route('lista.store') }}">
                                ...
                                @csrf
                                <div class="mb-3">
                                    <label for="ListaName" class="form-label">Nombre</label>
                                    <input type="text" class="form-control" id="listaName" name="nombre" required>
                                </div>
                                <div class="mb-3">
